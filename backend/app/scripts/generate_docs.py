...
ENGINES = [
    ...
    ("05_Attendance_Policy_Engine_API", "Attendance Policy Engine", "Metadata-driven master rules for late, grace, and overflow.", "Organization Engine", "Attendance Engine", ["AttendancePolicy", "LatePenaltyRule", "ShiftAttendancePolicy"]),
