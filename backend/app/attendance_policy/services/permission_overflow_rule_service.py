...
class PermissionOverflowRuleService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = PermissionOverflowRuleRepository(db)
        self.validator = PermissionOverflowRuleValidator(db)
        
    async def create(self, data: PermissionOverflowRuleCreate, user_id: str = None) -> PermissionOverflowRuleModel:
    ...
    async def get_by_id(self, id: str) -> Optional[PermissionOverflowRuleModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: PermissionOverflowRuleUpdate, user_id: str = None) -> Optional[PermissionOverflowRuleModel]:
