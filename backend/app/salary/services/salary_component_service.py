...
from app.salary.repositories.salary_component_repository import SalaryComponentRepository
from app.salary.validators.salary_component_validator import SalaryComponentValidator
