...
class EmployeeSalaryRevisionService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = EmployeeSalaryRevisionRepository(db)
        self.validator = EmployeeSalaryRevisionValidator(db)
        
    async def create(self, data: EmployeeSalaryRevisionCreate, user_id: str = None) -> EmployeeSalaryRevisionModel:
    ...
    async def get_by_id(self, id: str) -> Optional[EmployeeSalaryRevisionModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: EmployeeSalaryRevisionUpdate, user_id: str = None) -> Optional[EmployeeSalaryRevisionModel]:
