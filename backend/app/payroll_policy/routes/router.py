...
from app.payroll_policy.services.activation_service import PolicyActivationService
from pydantic import BaseModel

router = APIRouter(prefix="/payroll-policy", tags=["Payroll Policy"])
...
async def activate_policy(req: ActivationRequest, db = Depends(get_database)):
    ...
    '''
    svc = PolicyActivationService(db, "payroll_policy_versions")
