...
class LeaveEligibilityRuleService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = LeaveEligibilityRuleRepository(db)
        self.validator = LeaveEligibilityRuleValidator(db)
        
    async def create(self, data: LeaveEligibilityRuleCreate, user_id: str = None) -> LeaveEligibilityRuleModel:
    ...
    async def get_by_id(self, id: str) -> Optional[LeaveEligibilityRuleModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: LeaveEligibilityRuleUpdate, user_id: str = None) -> Optional[LeaveEligibilityRuleModel]:
