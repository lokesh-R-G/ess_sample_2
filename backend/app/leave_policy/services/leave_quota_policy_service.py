...
class LeaveQuotaPolicyService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = LeaveQuotaPolicyRepository(db)
        self.validator = LeaveQuotaPolicyValidator(db)
        
    async def create(self, data: LeaveQuotaPolicyCreate, user_id: str = None) -> LeaveQuotaPolicyModel:
    ...
    async def get_by_id(self, id: str) -> Optional[LeaveQuotaPolicyModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: LeaveQuotaPolicyUpdate, user_id: str = None) -> Optional[LeaveQuotaPolicyModel]:
