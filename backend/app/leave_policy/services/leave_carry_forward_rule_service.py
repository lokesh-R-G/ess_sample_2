...
class LeaveCarryForwardRuleService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = LeaveCarryForwardRuleRepository(db)
        self.validator = LeaveCarryForwardRuleValidator(db)
        
    async def create(self, data: LeaveCarryForwardRuleCreate, user_id: str = None) -> LeaveCarryForwardRuleModel:
    ...
    async def get_by_id(self, id: str) -> Optional[LeaveCarryForwardRuleModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: LeaveCarryForwardRuleUpdate, user_id: str = None) -> Optional[LeaveCarryForwardRuleModel]:
