...
from app.permission.repositories.permission_history_repository import PermissionHistoryRepository
from app.permission.validators.permission_history_validator import PermissionHistoryValidator
