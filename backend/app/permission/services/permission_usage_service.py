...
class PermissionUsageService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = PermissionUsageRepository(db)
        self.validator = PermissionUsageValidator(db)
        
    async def create(self, data: PermissionUsageCreate, user_id: str = None) -> PermissionUsageModel:
    ...
    async def get_by_id(self, id: str) -> Optional[PermissionUsageModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: PermissionUsageUpdate, user_id: str = None) -> Optional[PermissionUsageModel]:
