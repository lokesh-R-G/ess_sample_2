...
class LeaveCalendarService:
    def __init__(self, db: AsyncIOMotorDatabase):
        self.db = db
        self.repo = LeaveCalendarRepository(db)
        self.validator = LeaveCalendarValidator(db)
        
    async def create(self, data: LeaveCalendarCreate, user_id: str = None) -> LeaveCalendarModel:
    ...
    async def get_by_id(self, id: str) -> Optional[LeaveCalendarModel]:
        return await self.repo.get_by_id(id)
        
    async def update(self, id: str, data: LeaveCalendarUpdate, user_id: str = None) -> Optional[LeaveCalendarModel]:
