...
from app.attendance_v2.repositories.attendance_log_repository import AttendanceLogRepository
from app.attendance_v2.validators.attendance_log_validator import AttendanceLogValidator
